...
hospital = Hospital("Amrita", "Coimbatore")
                ...
                with st.form('input'):
                    ...
                    with c1:
                        first_name = st.text_input(
                            label="First Name", placeholder="Srishti").strip()

                        age = st.text_input(
                            label="Age", placeholder=23, max_chars=2).strip()

                        specialization = st.text_input(
                            label="Specialization", placeholder="Dentist").strip()

                    with c2:
                        last_name = st.text_input(
                            label="Last Name", placeholder="Prasanna").strip()
                    ...
                    if add_doctor:
                        ...
                        if flag_phone == False:
                            st.warning(
                                'Please Enter A Valid Phone Number Which Starts With [010/ 012/ 015/ 011]!')
                        ...
                        with st.spinner(text='Saving All Doctors'):
                            ...
                            if hospital.save_doctor() == 0:
                                st.info(
                                    'Ensure All The Fields Are Entered Correctly')
                            else:
                                st.success(
                ...
                with st.form('adding_existing_nurse'):
                    ...
                    with col_1:
                        doctor_name = st.text_input(
                            label="Doctor Name", placeholder="Srishti Prasanna").strip()

                        st.write("***")

                        nurse_name = st.text_input(
                            label="Nurse Name", placeholder="Ben Whatson").strip()
                    ...
                    if add_nurse_to_team:
                        ...
                        if flag_doctor_name == False:
                            st.warning(
                                'Please Enter The Doctors Name Correctly!')
                        ...
                        if flag_nurse_name == False:
                            st.warning(
                                'Please Enter The Nurses Name Correctly!')
